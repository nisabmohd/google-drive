...
export const Leftbar = () => {
    return (
        <div className='leftbar' style={{width:'13%'}}>
            <button style={{width:'45%',display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center',backgroundColor:'rgba(0, 0, 0, 0.12)',outline:'none',border:'none',height:'39px',borderRadius:'32px',marginLeft:'22px',cursor:'pointer',marginBottom:'7px',marginTop:'15px',color:'inherit'}}><AddIcon style={{marginRight:'6px',marginLeft:'-9px'}}/><h4>New</h4></button>
            <Link to="/" className="tags" style={{marginLeft:'22px',display:'flex',flexDirection:'row',alignItems:'center',marginBottom:'7px',marginTop:'7px',textDecoration:'none',height:'39px',paddingLeft:'9px',borderRadius:'7px 25px 25px 7px',textDecorationColor:'none',color:'inherit'}}>
